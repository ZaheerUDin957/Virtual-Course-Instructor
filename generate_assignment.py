...
def generate_assignment():
    st.title("Upload document to generate assignment of the topic")
    ...
    if uploaded_file and api_key:
        ...
        if documents:
            ...
            Prompt = """
            You are an expert assignment generator. Create an academic assignment based on the following document. Ensure the assignment is clear, engaging, and aligned with educational objectives. The assignment should include the following:

            1. **Title**: A concise title reflecting the main theme of the document.
            2. **Introduction**: A brief overview of the topic to provide context for the questions.
            3. **Instructions**: Clear instructions on how to complete the assignment.
            4. **Questions**: Generate a variety of question types, including:
                - **Short Answer Questions**: To assess comprehension and key concepts.
                - **Essay Questions**: To encourage critical thinking and in-depth analysis.
                - **Problem-Solving Questions**: If applicable, include real-world scenarios or problems related to the document's content.
                - **Discussion Questions**: To promote reflection and class discussions.
            5. **Grading Criteria**: A brief guideline on how the assignment will be assessed.
